...
def calculate():
    ...
    animate_widget(bmi_label, [("bg", "green"), ("bg", "SystemButtonFace")])
    animate_widget(category_label, [("bg", "yellow"), ("bg", "SystemButtonFace")])
    animate_widget(weight_range_label, [("bg", "orange"), ("bg", "SystemButtonFace")])
    animate_widget(height_range_label, [("bg", "red"), ("bg", "SystemButtonFace")])

    animate_widget(calculate_button, [("bg", "green"), ("bg", "#4CAF50")])
...
weight_entry_animation = [("bg", "green"), ("bg", "SystemButtonFace")]
...
weight_unit_combo_animation = [("bg", "green"), ("bg", "SystemButtonFace")]
...
height_entry_animation = [("bg", "green"), ("bg", "SystemButtonFace")]
...
height_unit_combo_animation = [("bg", "green"), ("bg", "SystemButtonFace")]
